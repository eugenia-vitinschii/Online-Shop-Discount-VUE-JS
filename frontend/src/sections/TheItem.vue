  ...
  <div class="item__item" :class="{ gray: !stock }">
    ...
    <div class="item__top">
      <div class="item__top-logo">
        <router-link :to="'/brands/' + brand"  :class="{ grayscale: !stock }">
    ...
    <div class="item__buttons">
      ...
      <div class="item__buttons-action">
        <!-- add item to cart -->
        <button class="button-svg" @click="$emit('addToCard', product)">
          <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e8eaed">
            <path
        ...
        <button class="button-svg" @click="$emit('addToFavorite', product)">
          <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e8eaed">
            <path
